-- =============================================================================
-- lsyncd Configuration for Node 2
-- Description: Bidirectional recording synchronization
-- Syncs: /var/lib/freeswitch/recordings/ to Node 1
-- =============================================================================
...
-- Sync recordings to Node 1 via rsync over SSH
sync {
    default.rsync,
    source = "/var/lib/freeswitch/recordings/",
    target = "root@192.168.1.101:/var/lib/freeswitch/recordings/",
...
--
-- 3. Copy public key to Node 1:
--    ssh-copy-id -i /root/.ssh/lsyncd_rsa.pub root@192.168.1.101
--
-- 4. Test SSH connection:
--    ssh -i /root/.ssh/lsyncd_rsa root@192.168.1.101 "echo OK"
--
